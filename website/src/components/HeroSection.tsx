...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="animate-float-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <Button
              ...
              size="lg"
              asChild
              className="border-primary/30 hover:border-primary/60 transition-smooth"
            >
              <a
          ...
          <div className="flex flex-wrap justify-center gap-8 text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-2">
              <div
                className="w-3 h-3 bg-graph-node-2 rounded-full animate-graph-pulse"
            ...
            <div className="flex items-center gap-2">
              <div
                className="w-3 h-3 bg-graph-node-3 rounded-full animate-graph-pulse"
      ...
      <div
        className="absolute top-20 left-10 w-8 h-8 graph-node animate-graph-pulse"
        style={{ animationDelay: "0.2s" }}
      />
      <div
        className="absolute top-40 right-20 w-6 h-6 graph-node animate-graph-pulse"
        style={{ animationDelay: "0.8s" }}
      />
      <div
        className="absolute bottom-32 left-20 w-10 h-10 graph-node animate-graph-pulse"
        style={{ animationDelay: "1.2s" }}
      />
      <div
        className="absolute bottom-20 right-10 w-7 h-7 graph-node animate-graph-pulse"
