...
interface DemoSectionProps {
    autoplay?: boolean; // if true, video will autoplay
}
const DemoSection: React.FC<DemoSectionProps> = ({ autoplay = true }) => {
                ...
                <div className="text-center mb-16">
                    ...
                    <div className="max-w-4xl mx-auto mb-16">
                        <div className="relative aspect-video rounded-lg overflow-hidden shadow-2xl border border-border/50">
                            <iframe
                                src={`https://www.youtube.com/embed/KYYSdxhg1xU?autoplay=${autoplay ? 1 : 0}&mute=1`}
